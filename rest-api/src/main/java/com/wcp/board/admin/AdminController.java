...
@Controller
@RequestMapping(value = "/wcp/board/admin")
public class AdminController {
    ...
    {
        try{
            Optional<AdminBoard> adminBoard = adminBoardService.fetchById(postId);
            return new ResponseEntity<String>(gson.toJson(adminBoard), HttpStatus.OK);
        }catch (Throwable t){
    ...
    {
        try{
            AdminBoard AdminBoard = gson.fromJson(body, AdminBoard.class);
